...
function Otp_Mail(){
    ...
    $mail->Subject = 'Alert! Sharerapidly Password Changed';
    ...
    <tr>
        ...
        <p><b>Your Password Has Been Changed Successfully</b></p>
        <p>If It's Not You <a href='". base_url() ."signin'>Click Here To Secure</a></p>
